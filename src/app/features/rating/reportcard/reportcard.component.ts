...
const Skillcode30 = [
  ...
  { Skillcode: '30-6', Description: 'Able to hit a medium paced volley with direction and consistency', Level: '3.0' },
...
const Skillcode25 = [
  ...
  { Skillcode: '25-4', Description: 'Accurately places serve into correct square focusing on direction', Level: '2.5' },
...
const Skillcode50 = [
  ...
  {
    Skillcode: '50-13',
    Description: 'Comfortable with swinging volley in both initiating and ability to attack back or neutralize return',
    Level: '5.0',
  },
  {
    Skillcode: '50-14',
...
const SkillcodeList = [
  ...
  { Skillcode: '35-13', Description: 'Moves quickly to NVZ (non-volley zone) when opportunity is there', Level: '3.5' },
  ...
  { Skillcode: '40-4', Description: 'Consistently gets return of serve in with varying depth and speed', Level: '4.0' },
  {
    Skillcode: '40-5',
  ...
  { Skillcode: '40-7', Description: 'Able to sustain dink rally with control, height and depth of shot', Level: '4.0' },
  {
    Skillcode: '40-8',
  ...
  { Skillcode: '40-11', Description: 'Able to change soft shots to power shots to create an advantage', Level: '4.0' },
  ...
  { Skillcode: '45-13', Description: 'Has good footwork and moves laterally, forward and backward well', Level: '4.5' },
...
export class ReportcardComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.model['level'] == '4.5') {
      objModel = this.performFilter('4.5');
    }

    if (this.model['level'] == '4.0') {
      objModel = this.performFilter('4.0');
      //objModel = Skillcode40;
    }

    if (this.model['level'] == '3.5') {
      objModel = this.performFilter('3.5');
      //objModel = Skillcode35;
    }

    objModel = this.performFilter(filterLevel);
  ...
  performFilter(filterBy: string): any[] {
    ...
    return SkillcodeList.filter((Skillcode: any) => Skillcode.Level.toLocaleLowerCase().indexOf(filterBy) !== -1);
  }
}
